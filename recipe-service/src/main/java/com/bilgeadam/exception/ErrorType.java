...
public enum ErrorType {
    ...
    RECIPE_NOT_FOUND(4400, "Kullanıcıya ait böyle bir yemek tarifi bulunamadı.", HttpStatus.NOT_FOUND),
    ...
    ONLY_ADMIN( 4200, "Sadece ADMIN işlem yapabilir.", HttpStatus.BAD_REQUEST);
